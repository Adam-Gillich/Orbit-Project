...
set title "All types of DeltaV loss [RSS]"
set xlabel "time [s]"
...
set label "Burnout" at 355, graph 0.9 center

set tmargin 2.1

plot "RSS_Kourou.csv" using 1:15 w l linecolor 2 lw 2 title "dV Grav", \
...
#set output "all_dV_loss(RSS).png"
#replot
